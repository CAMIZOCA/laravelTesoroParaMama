        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
                ...
                <div class="flex gap-4 mt-6">
                    ...
                    <a href="https://wa.me/{{ config('app.whatsapp_number') }}" target="_blank" rel="noopener noreferrer"
                       aria-label="WhatsApp"
                       class="text-cream-200 opacity-60 hover:opacity-100 hover:text-green-400 transition-all">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Contact -->
            <div>
                <h4 class="font-serif text-cream-50 text-lg font-semibold mb-4">Contáctanos</h4>
                <p class="text-cream-200 opacity-75 text-sm mb-4">¿Tienes dudas? Escríbenos, con gusto te ayudamos.</p>
                <a href="https://wa.me/{{ config('app.whatsapp_number') }}?text={{ urlencode('Hola! Tengo una consulta sobre los kits de joyería de leche materna.') }}"
                   target="_blank" rel="noopener noreferrer"
                   class="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 py-3 rounded-full text-sm font-medium transition-all duration-300 hover:scale-105 shadow-md">
