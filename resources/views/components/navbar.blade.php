    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="https://wa.me/{{ config('app.whatsapp_number') }}?text={{ urlencode('Hola! Me interesa pedir mi Kit de joyería de leche materna.') }}"
                   target="_blank" rel="noopener noreferrer"
                   class="btn-whatsapp-sm text-sm">
        ...
        <div x-show="open"
            ...
            <div class="pt-2">
                <a href="https://wa.me/{{ config('app.whatsapp_number') }}?text={{ urlencode('Hola! Me interesa pedir mi Kit de joyería de leche materna.') }}"
                   target="_blank" rel="noopener noreferrer"
                   class="btn-whatsapp-sm w-full justify-center">
                    Pedir mi Kit por WhatsApp
                </a>
            </div>
        </div>
    </div>
