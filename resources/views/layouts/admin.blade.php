        ...
        <aside class="w-64 bg-olive-900 text-cream-50 flex flex-col flex-shrink-0">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.testimonials.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-cream-100 hover:bg-olive-800 hover:text-white transition-colors {{ request()->routeIs('admin.testimonials*') ? 'bg-olive-800 text-white' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-3 pb-1">
                    <p class="text-xs uppercase tracking-widest text-cream-200 opacity-50 px-3 mb-2">Embajadoras</p>
                </div>

                <a href="{{ route('admin.ambassadors.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-cream-100 hover:bg-olive-800 hover:text-white transition-colors {{ request()->routeIs('admin.ambassadors*') ? 'bg-olive-800 text-white' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-3 pb-1">
                    <p class="text-xs uppercase tracking-widest text-cream-200 opacity-50 px-3 mb-2">Configuración</p>
                </div>

                <a href="{{ route('admin.shipping.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-cream-100 hover:bg-olive-800 hover:text-white transition-colors {{ request()->routeIs('admin.shipping*') ? 'bg-olive-800 text-white' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
