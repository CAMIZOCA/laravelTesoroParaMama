                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mt-4 pt-4 border-t border-cream-100">
                        ...
                        <a href="{{ route('producto.show', $product->slug) }}"
                           class="inline-flex items-center gap-1.5 bg-olive-900 hover:bg-olive-800 text-white text-sm font-medium px-4 py-2.5 rounded-full transition-all duration-300 hover:scale-105 shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
