  ...
  "address": {
    ...
    "addressLocality": "{{ $seo['schema_address'] ?? '' }}"
            ...
            {{-- ══════════════════════════════════════
                 TAB: WHATSAPP
            ══════════════════════════════════════ --}}
            <div x-show="tab === 'whatsapp'" class="space-y-5" style="display:none">
                <div class="admin-card">
                    <h3 class="font-semibold text-olive-900 mb-5 pb-3 border-b border-gray-100 flex items-center gap-2">
                        <span class="w-2 h-2 bg-gold-400 rounded-full"></span> Botón de WhatsApp
                    </h3>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg">
                            <div>
                                <p class="text-sm font-medium text-olive-900">Mostrar botón flotante</p>
                                <p class="text-xs text-gray-500 mt-0.5">Aparece en la esquina inferior derecha de todas las páginas</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="whatsapp_enabled" value="1"
                                       class="sr-only peer"
                                       {{ ($seo['whatsapp_enabled'] ?? '1') === '1' ? 'checked' : '' }}>
                        ...
                        <div>
                            <label class="form-label" for="whatsapp_number">
                                Número de WhatsApp
                                <span class="text-xs text-gray-400 font-normal ml-1">Solo dígitos, incluye código de país sin el +</span>
                            </label>
                            <input type="text" id="whatsapp_number" name="whatsapp_number"
                                   value="{{ old('whatsapp_number', $seo['whatsapp_number'] ?? '593999829469') }}"
                                   class="form-input font-mono" maxlength="20"
                                   placeholder="593999829469">
                            <p class="text-xs text-gray-400 mt-1">Ej: <code class="bg-gray-100 px-1 rounded">593999829469</code> para Ecuador (+593 999 829 469)</p>
                        </div>

                        {{-- Mensaje predefinido (solo lectura) --}}
                        <div>
                            <label class="form-label">Mensaje predefinido</label>
                            <div class="form-input bg-gray-50 text-gray-600 text-sm cursor-default select-all">
                                Hola, quiero más información sobre el kit de Un Tesoro Para Mamá.
                            </div>
                            <p class="text-xs text-gray-400 mt-1">El mensaje se envía automáticamente al abrir WhatsApp</p>
                        </div>
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-green-800">Así se verá el botón en el sitio</p>
                                <p class="text-xs text-green-600 mt-0.5">Botón verde flotante en la esquina inferior derecha</p>
                            </div>
                        </div>
                    </div>
                </div>
