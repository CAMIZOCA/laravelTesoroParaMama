        ...
        <div x-show="tab === 'instrucciones'" x-cloak class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
                ...
                <div>
                    ...
                    <div class="mb-3">
                        <img src="{{ asset('storage/' . $content['instr_step1_image']) }}" alt="Paso 1" class="h-28 rounded-lg object-cover">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
                ...
                <div>
                    ...
                    <div class="mb-3">
                        <img src="{{ asset('storage/' . $content['instr_step2_image']) }}" alt="Paso 2" class="h-28 rounded-lg object-cover">
                        <p class="text-xs text-gray-400 mt-1">Imagen actual. Sube otra para reemplazarla.</p>
                    </div>
                    @endif
